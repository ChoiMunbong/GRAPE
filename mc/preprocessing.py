...
def load_data_monti(dataset, testing=False, rating_map=None, post_rating_map=None):
    ...
    path_dataset = mc_path+'/raw_data/' + dataset + '/training_test_dataset.mat'
...
def load_official_trainvaltest_split(dataset, testing=False, rating_map=None, post_rating_map=None, ratio=1.0):
    ...
    fname = dataset
    data_dir = mc_path+'/raw_data/' + fname
    ...
    filename_train = mc_path+'/raw_data/' + dataset + '/u1.base'
    filename_test = mc_path+'/raw_data/' + dataset + '/u1.test'
    ...
    if dataset =='ml_100k':
        ...
        sep = r'|'
        movie_file = mc_path+'/raw_data/' + dataset + '/u.item'
        ...
        sep = r'|'
        users_file = mc_path+'/raw_data/' + dataset + '/u.user'
        ...
        # load movie features
        movies_file = mc_path+'/raw_data/' + dataset + '/movies.dat'
        ...
        # load user features
        users_file = mc_path+'/raw_data/' + dataset + '/users.dat'
